...
simulate user activities in RedTeam Labs
Authors:  Youssef ENNACIRI (@YDY&4)

.DESCRIPTION

Helps in simulating user activities to make Lab as realistic as possible
...
function Lab-User-ConfigureHosts {
<#
.SYNOPSIS

Configure remote hosts in preperation for Lab-User
